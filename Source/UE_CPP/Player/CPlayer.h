...
{
	// ACharacter 
	// SkeletealmeshComponent : 뼈대 메쉬 기능
	// ArrowComponent : 방향 기능
	// ChatacterMovementComponent : 움직임 기능
...
private :
	...
	// Camera 가 사물을 감지하여 플레이어를 촬영할 수 있도록 SpringArmComponent 를 추가합니다.

	UPROPERTY(VisibleDefaultsOnly)
		class UCameraComponent* Camera;
	// Player 를 보여줄 수 있도록 Camera 를 설정합니다.
