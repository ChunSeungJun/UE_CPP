...
// CooreMinimal : Engine 에서 사용할 수 있는 기본 기능들을 모아놓은 파일
...
private :
	...
	EditAnywhere	 : 아키 타입 , 인스턴스 타입에서 모두 공개하며 편집이 가능합니다.
	EditInstanceOnly : 인스턴스 타입에서만 공개하며 편집이 가능합니다.
	EditDefaultsOnly : 아키 타입에서만 공개하며 편집이 가능합니다.
	VisibleAnywhere  : 아키 타입 , 인스턴스 타입에서 모두 공개하며 편집이 불가능합니다.
	*/
	...
	맴버 변수 Var1, Var2, Var3, Var4 를 선언해주세여.

	Var1 은 아키타입과 인스턴스타입에서 공개하고 편집이 불가능하여야 합니다.
	Var2 은 아키타입에서 공개하고 편집이 가능하여야 합니다.
	Var3 은 아키타입과 인스턴스타입에서 공개하고 편집이 가능하여야 합니다.
	Var4 은 인스턴스타입에서 공개하고 편집이 가능하여야 합니다.
